...
public class tutionpost2 extends Fragment implements SearchView.OnQueryTextListener {
    ...
    private void ambulence() {
        ...
        String url = "https://wikipediabangla.com/apps/tutionpost.php";
        ...
        public void onBindViewHolder(@NonNull MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
            ...
            holder.card.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    dialog.setContentView(R.layout.tutionpost2);
                    ...
                    approve = dialog.findViewById(R.id.approve);
                    ...
                    approve.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            String url = "https://wikipediabangla.com/apps/tutionpostapprove.php?id="+idx+"&status=confirmed";
                            ...
                            StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
                                ...
                                public void onResponse(String response) {
                                    if (response.contains("Success")){
                                        ...
                                        android.app.AlertDialog alertDialog = new android.app.AlertDialog.Builder(getContext()).create();
                                        alertDialog.setTitle("Alert");
                                        alertDialog.setMessage("Post Approved successfully.");
                                        alertDialog.setButton(AlertDialog.BUTTON_POSITIVE, "OK", new DialogInterface.OnClickListener() {
                                            public void onClick(DialogInterface dialog, int which) {
                                                dialog.dismiss();
