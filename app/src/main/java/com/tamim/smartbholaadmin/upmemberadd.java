...
public class upmemberadd extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View myView = inflater.inflate(R.layout.fragment_upmemberadd, container, false);
    ...
    private void school() {
        ...
        String url = "https://wikipediabangla.com/apps/unions2.php";
    ...
    private class Myadapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            View viewx = layoutInflater.inflate(R.layout.union, parent, false);

            TextView name1, union1,podobi1,mobile1,village1,upozila1;
            name1 = viewx.findViewById(R.id.name);
            union1 = viewx.findViewById(R.id.union);
            mobile1 = viewx.findViewById(R.id.mobile);
            podobi1 = viewx.findViewById(R.id.podobi);
            village1 = viewx.findViewById(R.id.village);
            ...
            String villagex = hashMap.get("village");
            ...
            union1.setText("ইউনিয়নঃ  "+namex);
            mobile1.setText("মোবাইলঃ  "+mobilex);
            village1.setText("ওয়ার্ডঃ  "+villagex);
            ...
            delete.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    String url = "https://wikipediabangla.com/apps/unions3.php?id="+idx;
                ...
                public void onClick(View v) {
                    ...
                    adddata2.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            String url = "https://wikipediabangla.com/apps/unions4.php?id="+idx+"&name="+namex+"&village="+villagex+"&podobi="+podobix+"&member="+memberx+"&mobile="+mobilex+"&upozila="+upozilax;
