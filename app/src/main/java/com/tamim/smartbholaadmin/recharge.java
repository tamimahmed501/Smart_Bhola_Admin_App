...
public class recharge extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View myView = inflater.inflate(R.layout.fragment_recharge, container, false);
    ...
    private void school() {
        ...
        String url = "https://wikipediabangla.com/apps/offer/pendingr.php";
    ...
    private class Myadapter extends BaseAdapter {
        ...
        public View getView(int position, View viewx, ViewGroup parent) {
            if (viewx == null) {
                ...
                viewx = layoutInflater.inflate(R.layout.recharge, parent, false);
            }
            ...
            if (!adminx.isEmpty()){
                ...
                admin.setTextColor(R.color.black);
            ...
            proccess.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    String url1 = "https://wikipediabangla.com/apps/offer/proccessing.php?id="+id+"&admin="+namex;
            ...
            success.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    String url1 = "https://wikipediabangla.com/apps/offer/proccessing2.php?id="+id+"&status="+"Success";
                    StringRequest stringRequest = new StringRequest(0, url1, new Response.Listener<String>() {
                        @Override
                        public void onResponse(String response) {
            ...
            cancel.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    String url1 = "https://wikipediabangla.com/apps/offer/proccessing2.php?id="+id+"&status="+"Cancel";
                    StringRequest stringRequest = new StringRequest(0, url1, new Response.Listener<String>() {
                        @Override
                        public void onResponse(String response) {
