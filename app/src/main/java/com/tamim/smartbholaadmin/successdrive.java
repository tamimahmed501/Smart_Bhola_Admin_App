...
public class successdrive extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View myView = inflater.inflate(R.layout.fragment_successdrive, container, false);
    ...
    private void school() {
        ...
        String url = "https://wikipediabangla.com/apps/offer/successoffer.php";
    ...
    private class Myadapter extends BaseAdapter {
        ...
        public View getView(int position, View viewx, ViewGroup parent) {
            if (viewx == null) {
                ...
                viewx = layoutInflater.inflate(R.layout.successdrive, parent, false);
            }
