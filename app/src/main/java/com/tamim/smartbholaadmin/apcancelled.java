...
public class apcancelled extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View myView = inflater.inflate(R.layout.fragment_apcancelled, container, false);
    ...
    private void school() {
        ...
        String uidx = sharedPreferencesx.getString("uid", "");

        String url = "https://wikipediabangla.com/apps/appointment/apcancelled2.php";
    ...
    private class Myadapter extends BaseAdapter {
        ...
        public View getView(int position, View viewx, ViewGroup parent) {
            if (viewx == null) {
                ...
                viewx = layoutInflater.inflate(R.layout.cancelledap, parent, false);
            }
