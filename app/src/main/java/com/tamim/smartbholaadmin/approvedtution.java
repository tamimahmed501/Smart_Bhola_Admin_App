...
public class approvedtution extends Fragment implements SearchView.OnQueryTextListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View myView = inflater.inflate(R.layout.fragment_approvedtution, container, false);
    ...
    private void ambulence() {
        ...
        String url = "https://wikipediabangla.com/apps/tutionfind.php";
    ...
    private class MyAdapter extends RecyclerView.Adapter<MyAdapter.MyViewHolder> {
        ...
        public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.approvedtution, parent, false);
