...
public class pendingap extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View myView = inflater.inflate(R.layout.fragment_pendingap, container, false);
    ...
    private void school() {
        ...
        String url = "https://wikipediabangla.com/apps/pendingap2.php";
    ...
    private class Myadapter extends BaseAdapter {
        ...
        public View getView(int position, View viewx, ViewGroup parent) {
            if (viewx == null) {
                ...
                viewx = layoutInflater.inflate(R.layout.pendingap, parent, false);
            }


            TextView name1,patient1,time1,status1,payment1,date1,problem1,mobile1,id1,clinic;

            CardView accept,cancel,call;
            ...
            accept = viewx.findViewById(R.id.accept);
            ...
            accept.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    String url5 = "https://wikipediabangla.com/apps/appointment/apaccept.php?status=confirmed"+"&id="+id;
                    ...
                    StringRequest stringRequest = new StringRequest(Request.Method.GET, url5, new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            if (response.contains("success")){
                                ...
                                UID = uid;
                                TITLE = "Appointment Granted";
                                BODY = "Doctor Name:"+doctor+", Dignostic Center: "+clinic+", Appointment ID: "+id;
                    ...
                    StringRequest stringRequest = new StringRequest(Request.Method.GET, url5, new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            if (response.contains("success")){
                                ...
                                BODY = "Appointment ID: "+id+",  নির্ধারিত সময়ের মাঝে উপস্থিত হতে না পারার জন্য আপনার এপয়েন্টমেন্ট বাতিল করা হলো ";
